...
export default function (ccpContainerId) {
    ...
    const ccpUrl = "https://<amazonconnect-instance-name>.my.connect.aws/connect/ccp-v2";
    ...
    // connect.getContactTraceRecords(params, function (err, data) {
    //     if (err) console.log(err, err.stack);
    //     else console.log('Contact Trace Records:', data);
    //   });
